...
assertEqual(#sent_payload.toc.entries, 6, "the full normalized TOC is sent for server mapping")
assertEqual(sent_payload.toc.entries[1].title, "Part I", "front matter and structural entries are retained")
assertEqual(sent_payload.toc.entries[2].title, "CHAPTER III.", "current and neighboring entries retain raw titles")
